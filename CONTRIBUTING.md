...
To start contributing to SmartSurf, you first need to clone the GitHub repository:

```
git clone https://github.com/adetyaz/smartsurf.git
```
...
SmartSurf uses [Prettier](https://prettier.io/) to format its code. Before submitting a pull request, please run the following command to ensure that your code is properly formatted:
...
SmartSurf uses ESLint for linting the code. Make sure you linted your code before you make a commit, please run the following command to ensure that your code is properly linted:
...
Thank you for contributing to SmartSurf!
